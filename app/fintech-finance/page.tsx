...
const SLUG = "triolla-io-fintech-finance";
const LOCALE = "en";

// React.cache deduplicates calls within the same request — generateMetadata
// and the page component both call this but the disk read + registry lookup
// only happens once.
...
export default async function FintechFinancePage() {
