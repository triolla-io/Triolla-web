...
const SLUG = "triolla-io-blog-animation-in-ui-design-from-concept-to-reality";
const LOCALE = "en";
...
export default async function BlogAnimationInUiDesignFromConceptToRealityPage() {
