...
const SLUG = "triolla-io-blog-if-ux-is-life-itself-it-must-be-designed-for-people-everywhere-and-always";
const LOCALE = "en";
...
export default async function BlogIfUxIsLifeItselfItMustBeDesignedForPeopleEverywhereAndAlwaysPage() {
