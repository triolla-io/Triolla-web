...
const SLUG = "triolla-io-blog-beyond-graphics-deep-user-experience-design-for-tomorrows-gaming-apps";
const LOCALE = "en";
...
export default async function BlogBeyondGraphicsDeepUserExperienceDesignForTomorrowsGamingAppsPage() {
