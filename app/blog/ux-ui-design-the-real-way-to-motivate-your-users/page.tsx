...
const SLUG = "triolla-io-blog-ux-ui-design-the-real-way-to-motivate-your-users";
const LOCALE = "en";
...
export default async function BlogUxUiDesignTheRealWayToMotivateYourUsersPage() {
