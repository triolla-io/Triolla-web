...
const SLUG = "triolla-io-blog-product-managers-manage-your-product-design-process-with-these-simple-steps";
const LOCALE = "en";
...
export default async function BlogProductManagersManageYourProductDesignProcessWithTheseSimpleStepsPage() {
