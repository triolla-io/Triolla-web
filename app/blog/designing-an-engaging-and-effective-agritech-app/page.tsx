...
const SLUG = "triolla-io-blog-designing-an-engaging-and-effective-agritech-app";
const LOCALE = "en";
...
export default async function BlogDesigningAnEngagingAndEffectiveAgritechAppPage() {
