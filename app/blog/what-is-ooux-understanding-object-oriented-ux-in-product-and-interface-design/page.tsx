...
const SLUG = "triolla-io-blog-what-is-ooux-understanding-object-oriented-ux-in-product-and-interface-design";
const LOCALE = "en";
...
export default async function BlogWhatIsOouxUnderstandingObjectOrientedUxInProductAndInterfaceDesignPage() {
