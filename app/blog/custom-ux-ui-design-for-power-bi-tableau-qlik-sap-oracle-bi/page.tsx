...
const SLUG = "triolla-io-blog-custom-ux-ui-design-for-power-bi-tableau-qlik-sap-oracle-bi";
const LOCALE = "en";
...
export default async function BlogCustomUxUiDesignForPowerBiTableauQlikSapOracleBiPage() {
