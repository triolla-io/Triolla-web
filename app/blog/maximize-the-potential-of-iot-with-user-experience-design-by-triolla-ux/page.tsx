...
const SLUG = "triolla-io-blog-maximize-the-potential-of-iot-with-user-experience-design-by-triolla-ux";
const LOCALE = "en";
...
export default async function BlogMaximizeThePotentialOfIotWithUserExperienceDesignByTriollaUxPage() {
