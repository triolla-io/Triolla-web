...
const SLUG = "triolla-io-blog-product-managers-must-understand-why-is-tiktok-so-addictive";
const LOCALE = "en";
...
export default async function BlogProductManagersMustUnderstandWhyIsTiktokSoAddictivePage() {
