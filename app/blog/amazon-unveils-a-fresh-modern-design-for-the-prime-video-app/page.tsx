...
const SLUG = "triolla-io-blog-amazon-unveils-a-fresh-modern-design-for-the-prime-video-app";
const LOCALE = "en";
...
export default async function BlogAmazonUnveilsAFreshModernDesignForThePrimeVideoAppPage() {
