...
const SLUG = "triolla-io-blog-the-essential-questions-to-consider-before-meeting-with-a-ux-ui-design-agency";
const LOCALE = "en";
...
export default async function BlogTheEssentialQuestionsToConsiderBeforeMeetingWithAUxUiDesignAgencyPage() {
