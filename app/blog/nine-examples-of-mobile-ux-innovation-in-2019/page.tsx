...
const SLUG = "triolla-io-blog-nine-examples-of-mobile-ux-innovation-in-2019-1";
const LOCALE = "en";
...
export default async function BlogNineExamplesOfMobileUxInnovationIn2019Page() {
