...
const SLUG = "triolla-io-blog-calcalist-triolla-named-best-ux-ui-agency-in-israel";
const LOCALE = "en";
...
export default async function BlogCalcalistTriollaNamedBestUxUiAgencyInIsraelPage() {
