...
const SLUG = "triolla-io-blog-triollas-mobile-app-ux-mastery-will-make-your-app-a-sensation";
const LOCALE = "en";
...
export default async function BlogTriollasMobileAppUxMasteryWillMakeYourAppASensationPage() {
