...
const SLUG = "triolla-io-blog-ahead-of-the-curve-key-ux-ui-developments-to-watch-in-2024-1";
const LOCALE = "en";
...
export default async function BlogAheadOfTheCurveKeyUxUiDevelopmentsToWatchIn2024Page() {
