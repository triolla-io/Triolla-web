...
const SLUG = "triolla-io-blog-unleash-the-power-of-your-mvp-to-accelerate-your-growth-ux-design-for-startups";
const LOCALE = "en";
...
export default async function BlogUnleashThePowerOfYourMvpToAccelerateYourGrowthUxDesignForStartupsPage() {
