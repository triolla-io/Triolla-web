...
const SLUG = "triolla-io-blog-ui-company-boosting-your-products-chances-of-success";
const LOCALE = "en";
...
export default async function BlogUiCompanyBoostingYourProductsChancesOfSuccessPage() {
