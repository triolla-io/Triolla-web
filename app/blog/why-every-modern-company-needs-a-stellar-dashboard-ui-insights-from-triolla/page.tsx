...
const SLUG = "triolla-io-blog-why-every-modern-company-needs-a-stellar-dashboard-ui-insights-from-triolla";
const LOCALE = "en";
...
export default async function BlogWhyEveryModernCompanyNeedsAStellarDashboardUiInsightsFromTriollaPage() {
