...
const SLUG = "triolla-io-blog-user-experience-design-for-apps-thats-nothing-short-of-excellent";
const LOCALE = "en";
...
export default async function BlogUserExperienceDesignForAppsThatsNothingShortOfExcellentPage() {
