...
const SLUG = "triolla-io-blog-power-users-the-key-to-your-apps-success-how-to-make-it-happen";
const LOCALE = "en";
...
export default async function BlogPowerUsersTheKeyToYourAppsSuccessHowToMakeItHappenPage() {
