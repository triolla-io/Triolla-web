...
const SLUG = "triolla-io-blog-a-complex-project-becomes-simple-with-the-ux-canvas";
const LOCALE = "en";
...
export default async function BlogAComplexProjectBecomesSimpleWithTheUxCanvasPage() {
