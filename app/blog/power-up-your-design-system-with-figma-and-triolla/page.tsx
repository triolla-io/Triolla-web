...
const SLUG = "triolla-io-blog-power-up-your-design-system-with-figma-and-triolla";
const LOCALE = "en";
...
export default async function BlogPowerUpYourDesignSystemWithFigmaAndTriollaPage() {
