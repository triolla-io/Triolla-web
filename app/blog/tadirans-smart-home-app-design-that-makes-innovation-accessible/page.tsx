...
const SLUG = "triolla-io-blog-tadirans-smart-home-app-design-that-makes-innovation-accessible";
const LOCALE = "en";
...
export default async function BlogTadiransSmartHomeAppDesignThatMakesInnovationAccessiblePage() {
