...
const SLUG = "triolla-io-blog-triolla-an-industry-leader-is-actually-a-boutique-ux-studio";
const LOCALE = "en";
...
export default async function BlogTriollaAnIndustryLeaderIsActuallyABoutiqueUxStudioPage() {
