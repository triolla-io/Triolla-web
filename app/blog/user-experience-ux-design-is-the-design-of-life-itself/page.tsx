...
const SLUG = "triolla-io-blog-user-experience-ux-design-is-the-design-of-life-itself";
const LOCALE = "en";
...
export default async function BlogUserExperienceUxDesignIsTheDesignOfLifeItselfPage() {
