...
const SLUG = "triolla-io-blog-why-is-a-ux-survey-a-crucial-step-in-product-definition";
const LOCALE = "en";
...
export default async function BlogWhyIsAUxSurveyACrucialStepInProductDefinitionPage() {
