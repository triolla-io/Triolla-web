...
const SLUG = "triolla-io-blog-the-essential-guide-to-designing-a-top-performing-cyber-app-mastering-cyber-ux";
const LOCALE = "en";
...
export default async function BlogTheEssentialGuideToDesigningATopPerformingCyberAppMasteringCyberUxPage() {
