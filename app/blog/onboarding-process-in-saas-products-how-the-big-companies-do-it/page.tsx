...
const SLUG = "triolla-io-blog-onboarding-process-in-saas-products-how-the-big-companies-do-it";
const LOCALE = "en";
...
export default async function BlogOnboardingProcessInSaasProductsHowTheBigCompaniesDoItPage() {
