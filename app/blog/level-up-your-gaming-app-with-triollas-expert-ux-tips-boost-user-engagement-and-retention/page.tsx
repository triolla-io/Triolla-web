...
const SLUG = "triolla-io-blog-level-up-your-gaming-app-with-triollas-expert-ux-tips-boost-user-engagement-and-retention";
const LOCALE = "en";
...
export default async function BlogLevelUpYourGamingAppWithTriollasExpertUxTipsBoostUserEngagementAndRetentionPage() {
