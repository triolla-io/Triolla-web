...
const SLUG = "triolla-io-blog-a-comprehensive-guide-to-mastering-mobile-app-design-for-israeli-startups-and-companies";
const LOCALE = "en";
...
export default async function BlogAComprehensiveGuideToMasteringMobileAppDesignForIsraeliStartupsAndCompaniesPage() {
