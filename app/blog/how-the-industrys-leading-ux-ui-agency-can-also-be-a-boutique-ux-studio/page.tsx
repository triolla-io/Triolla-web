...
const SLUG = "triolla-io-blog-how-the-industrys-leading-ux-ui-agency-can-also-be-a-boutique-ux-studio";
const LOCALE = "en";
...
export default async function BlogHowTheIndustrysLeadingUxUiAgencyCanAlsoBeABoutiqueUxStudioPage() {
