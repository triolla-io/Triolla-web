...
const SLUG = "triolla-io-blog-the-questions-every-entrepreneur-and-product-manager-must-be-able-to-answer-in-a-kickoff-meeting";
const LOCALE = "en";
...
export default async function BlogTheQuestionsEveryEntrepreneurAndProductManagerMustBeAbleToAnswerInAKickoffMeetingPage() {
