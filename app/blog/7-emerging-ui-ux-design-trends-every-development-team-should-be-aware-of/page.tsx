...
const SLUG = "triolla-io-blog-7-emerging-ui-ux-design-trends-every-development-team-should-be-aware-of";
const LOCALE = "en";
...
export default async function Blog7EmergingUiUxDesignTrendsEveryDevelopmentTeamShouldBeAwareOfPage() {
