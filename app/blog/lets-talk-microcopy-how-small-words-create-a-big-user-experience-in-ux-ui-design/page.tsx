...
const SLUG = "triolla-io-blog-lets-talk-microcopy-how-small-words-create-a-big-user-experience-in-ux-ui-design";
const LOCALE = "en";
...
export default async function BlogLetsTalkMicrocopyHowSmallWordsCreateABigUserExperienceInUxUiDesignPage() {
