...
const SLUG = "triolla-io-blog-ux-in-medtech-when-trust-is-a-matter-of-life-and-death";
const LOCALE = "en";
...
export default async function BlogUxInMedtechWhenTrustIsAMatterOfLifeAndDeathPage() {
