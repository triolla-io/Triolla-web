...
const SLUG = "triolla-io-blog-the-real-difference-between-a-product-manager-pm-and-a-product-owner-po";
const LOCALE = "en";
...
export default async function BlogTheRealDifferenceBetweenAProductManagerPmAndAProductOwnerPoPage() {
