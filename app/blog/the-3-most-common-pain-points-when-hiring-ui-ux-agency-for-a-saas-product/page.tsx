...
const SLUG = "triolla-io-blog-the-3-most-common-pain-points-when-hiring-ui-ux-agency-for-a-saas-product";
const LOCALE = "en";
...
export default async function BlogThe3MostCommonPainPointsWhenHiringUiUxAgencyForASaasProductPage() {
