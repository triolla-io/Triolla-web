...
const SLUG = "triolla-io-blog-the-unicorns-secret-to-conquering-product-success";
const LOCALE = "en";
...
export default async function BlogTheUnicornsSecretToConqueringProductSuccessPage() {
