...
const SLUG = "triolla-io-blog-a-comprehensive-guide-to-mastering-mobile-app-design-for-israeli-startups-corporates";
const LOCALE = "en";
...
export default async function BlogAComprehensiveGuideToMasteringMobileAppDesignForIsraeliStartupsCorporatesPage() {
