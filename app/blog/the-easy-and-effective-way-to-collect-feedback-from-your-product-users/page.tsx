...
const SLUG = "triolla-io-blog-the-easy-and-effective-way-to-collect-feedback-from-your-product-users";
const LOCALE = "en";
...
export default async function BlogTheEasyAndEffectiveWayToCollectFeedbackFromYourProductUsersPage() {
