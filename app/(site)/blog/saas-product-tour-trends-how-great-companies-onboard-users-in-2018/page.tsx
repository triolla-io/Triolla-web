...
const SLUG = "triolla-io-blog-saas-product-tour-trends-how-great-companies-onboard-users-in-2018-1";
const LOCALE = "en";
...
export default async function BlogSaasProductTourTrendsHowGreatCompaniesOnboardUsersIn2018Page() {
