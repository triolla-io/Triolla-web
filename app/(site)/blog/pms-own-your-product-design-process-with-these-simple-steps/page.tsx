...
const SLUG = "triolla-io-blog-pms-own-your-product-design-process-with-these-simple-steps";
const LOCALE = "en";
...
export default async function BlogPmsOwnYourProductDesignProcessWithTheseSimpleStepsPage() {
