...
const SLUG = "triolla-io-blog-can-design-be-too-user-friendly-exploring-the-limits-of-ux-ui-in-product-design";
const LOCALE = "en";
...
export default async function BlogCanDesignBeTooUserFriendlyExploringTheLimitsOfUxUiInProductDesignPage() {
