...
const SLUG = "triolla-io-blog-the-ultimate-product-design-process-the-best-practice-used-by-google-facebook-netflix-etc";
const LOCALE = "en";
...
export default async function BlogTheUltimateProductDesignProcessTheBestPracticeUsedByGoogleFacebookNetflixEtcPage() {
