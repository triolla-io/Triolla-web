...
const SLUG = "triolla-io-blog-designing-intuitive-and-secure-iot-products-for-the-future";
const LOCALE = "en";
...
export default async function BlogDesigningIntuitiveAndSecureIotProductsForTheFuturePage() {
