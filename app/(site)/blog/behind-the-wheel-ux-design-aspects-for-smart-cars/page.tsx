...
const SLUG = "triolla-io-blog-behind-the-wheel-ux-design-aspects-for-smart-cars";
const LOCALE = "en";
...
export default async function BlogBehindTheWheelUxDesignAspectsForSmartCarsPage() {
