...
const SLUG = "triolla-io-blog-six-things-you-need-to-check-before-hiring-a-ux-ui-agency";
const LOCALE = "en";
...
export default async function BlogSixThingsYouNeedToCheckBeforeHiringAUxUiAgencyPage() {
