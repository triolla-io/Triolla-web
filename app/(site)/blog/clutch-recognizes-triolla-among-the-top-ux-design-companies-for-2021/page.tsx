...
const SLUG = "triolla-io-blog-clutch-recognizes-triolla-among-the-top-ux-design-companies-for-2021-1";
const LOCALE = "en";
...
export default async function BlogClutchRecognizesTriollaAmongTheTopUxDesignCompaniesFor2021Page() {
