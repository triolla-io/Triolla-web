...
const SLUG = "triolla-io-blog-in-house-designers-or-a-ux-ui-agency-everything-you-need-to-know";
const LOCALE = "en";
...
export default async function BlogInHouseDesignersOrAUxUiAgencyEverythingYouNeedToKnowPage() {
