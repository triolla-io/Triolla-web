...
const SLUG = "triolla-io-blog-user-experience-design-in-agritech-products-for-the-agriculture-industry";
const LOCALE = "en";
...
export default async function BlogUserExperienceDesignInAgritechProductsForTheAgricultureIndustryPage() {
