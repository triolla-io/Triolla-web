...
const SLUG = "triolla-io-blog-how-to-prepare-for-a-product-manager-interview";
const LOCALE = "en";
...
export default async function BlogHowToPrepareForAProductManagerInterviewPage() {
