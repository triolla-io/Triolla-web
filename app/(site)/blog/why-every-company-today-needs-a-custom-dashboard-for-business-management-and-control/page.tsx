...
const SLUG = "triolla-io-blog-why-every-company-today-needs-a-custom-dashboard-for-business-management-and-control";
const LOCALE = "en";
...
export default async function BlogWhyEveryCompanyTodayNeedsACustomDashboardForBusinessManagementAndControlPage() {
