...
export function HebrewNavigation() {
  ...
  useEffect(() => {
    ...
    const menuLinks = navRef.current.querySelectorAll(".hmenumobdiv a");
    ...
    // Close ticker when close button is clicked
    ...
    <div ref={navRef} dir="rtl" className="hebrew-navigation">
          ...
          <div className="header_in cf">
                      ...
                      <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1976">
                        ...
                        <ul className="sub-menu">
                          ...
                          <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-2338">
                            <a href="/he/technology/">פיתוח מערכות</a>
                            <span className="marrow" />
                          </li>
                        </ul>
                      </li>
            ...
            <div className="header_right">
              ...
              <div className="header_whatsapp">
                <a href="https://api.whatsapp.com/send/?phone=+972525956644&text=&app_absent=0" target="_blank" rel="noopener noreferrer" aria-label="Contact via WhatsApp">
              ...
              <div className="header_book">
                <a href="https://calendly.com/triolla/pitangoux-introductory-meeting-clone" target="_blank" rel="noopener noreferrer" aria-label="Schedule a call">
      ...
      <div className={`hmenumob ${isMenuOpen ? "open" : ""}`}>
        ...
        <div className="hmenumobdiv">
          <div className="menu-header-menu-he-container">
            <ul id="menu-header-menu-he-mobile" className="menu">
              <li className="bigmenu menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                <a href="#">פורטפוליו</a>
                <span className="marrow" />
                <ul className="sub-menu">
                  <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                    ...
                    <span className="marrow" />
                    <ul className="sub-menu">
                      <li className="menu-item"><a href="/he/cyber-security/">אבטחת סייבר</a></li>
                      <li className="menu-item"><a href="/he/medical-healthcare/">רפואה ובריאות</a></li>
                      <li className="menu-item"><a href="/he/fintech-finance/">פינטק ופיננסים</a></li>
                      <li className="menu-item"><a href="/he/gaming/">גיימינג</a></li>
                      <li className="menu-item"><a href="/he/agritech/">אגריטק</a></li>
                      <li className="menu-item"><a href="/he/b2c/">B2C</a></li>
                    </ul>
                  </li>
                  <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                    <a href="#">מובייל</a>
                    <span className="marrow" />
                    <ul className="sub-menu">
                      <li className="menu-item"><a href="/he/iot/">מכשירים ו-IoT</a></li>
                      <li className="menu-item"><a href="/he/startups/">סטארט-אפים וטכנולוגיה</a></li>
                      <li className="menu-item"><a href="/he/mobile-apps/">אפליקציות מובייל</a></li>
                      <li className="menu-item"><a href="/he/saas/">SaaS</a></li>
                      <li className="menu-item"><a href="/he/b2b/">B2B</a></li>
                      <li className="menu-item"><a href="/he/technology/">פיתוח מערכות</a></li>
                    </ul>
                  </li>
                </ul>
              </li>
              <li className="menu-item"><a href="/he/services/">שירותים</a></li>
              <li className="menu-item"><a href="/he/technology/">טכנולוגיה</a></li>
              <li className="menu-item"><a href="/he/about/">אודותינו</a></li>
              <li className="menu-item"><a href="/he/contact/">צור קשר</a></li>
            </ul>
          </div>
        </div>
      </div>
