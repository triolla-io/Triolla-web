...
# How to Use Animation to Improve UX - Triolla
...
- [Heb](/he/blog/how-to-use-animation-to-improve-ux/)
...
Motion tells stories. Not long and complicated stories, but simple stories, like “hey, you need to look at this now” or “hurrah, your operation has just competed successfully.” However, [the goal](https://<a href="/">Home</a>) of animations isn’t entertaining the user, but rather they are helping the user understand what’s going on or how to use your app most effectively.


Animation may be used in a wide range of scales and contexts to unite beauty and function: it can influence behavior, communicate status, guide the users attention and help the user see the results of their actions. Here are just a few examples to illustrate places where you can add some animations in your UI to improve the experience:
...
For example, a menu icon may smoothly transition to a playback control, and back again. This effect both informs the user of the button’s function while adding an element of wonder to the interaction. [Transforming](https://<a href="/service-page/">Services</a>) the play icon into the pause also signifies that the two actions are connected, and that one cannot exist while the other is present.
...
Original article found at [UX Planet](https://uxplanet.org/how-to-use-animation-to-improve-ux-338819e93bdb), posted by Nick Babich
...
[[email protected]](/cdn-cgi/l/email-protection#0b4d7e654b7f79626467676a256264)
...
Mail: [[email protected]](/cdn-cgi/l/email-protection#d096a5be90a4a2b9bfbcbcb1feb9bf)
...
- [Eng](/blog/how-to-use-animation-to-improve-ux/)
